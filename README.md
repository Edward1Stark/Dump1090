...
- Ability to decode DF formats like DF0, DF4, DF5, DF16, DF20 and DF21 where the checksum is stored with the ICAO address by brute forcing the checksum field using recently seen ICAO addresses.
...
While from time to time I still add / fix stuff in my fork, I target minimalism of the implementation. However there is a much more feature complete fork available, [developed by MalcolmRobb.](https://github.com/MalcolmRobb/dump1090)
...
gcc --version
```
Install RTL-SDR development libraries
```bash
...
https://edwardstark.website/how-to-make-a-1090mhz-antenna/
## Aggressive mode
...
## Contributing
Help Improve Fighter Jet Detection
Simple steps to contribute:

- Find fighter jet data (public sources only)
- Create a military_aircraft.json file with the aircraft info
- Write code for instant alerts when fighters are detected on the webpage

No complex rules, just make it work! Follow the existing format and keep alerts noticeable.
## Special Thanks
